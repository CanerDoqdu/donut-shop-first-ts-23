        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <p className="text-xs text-gray-700 text-center">
              {t.byRegistering}{' '}
              <Link href="/terms" className="text-amber-700 underline underline-offset-2 hover:text-amber-800">
                {t.termsOfService}
              </Link>{' '}
              {t.and}{' '}
              <Link href="/privacy" className="text-amber-700 underline underline-offset-2 hover:text-amber-800">
                {t.privacyPolicy}
              </Link>
              {t.agreeText}
            </p>
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full py-3 border border-gray-200 rounded-xl font-medium hover:bg-gray-50 transition-colors flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {googleLoading ? (
